package oit.is.z0820.kaizi.janken.security;
...
public class JankenAuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    // $ sshrun htpasswd -nbBC 10 user2 p@ssword
    UserDetails user1 = users
        .username("user1")
        .password("$2y$10$Totd.Tqm9b/So1z2z70qHeTk.YwR56iXgb9HJftfqVj94z8KodLvy")
        .roles("USER")
        .build();
    UserDetails user2 = users
        .username("user2")
        .password("$2y$10$NoZtP0uDleqMZXhUWr9lx.dICYAzIqJvcGSKO3Oaih3NeZcPPenhy")
        .roles("USER")
        .build();
    UserDetails user3 = users
        .username("ほんだ")
        .password("$2y$10$XDkt9XmPwg.egXdfVbBWUu/V6FR7XauqpYPwruuz84.LjnHLhvF5W")
        .roles("USER")
        .build();
